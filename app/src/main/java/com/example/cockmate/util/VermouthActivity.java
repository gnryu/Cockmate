...
public class VermouthActivity extends AppCompatActivity {

    private static final String TAG = "VermouthActivity";
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_vermouth);
        context = getApplicationContext();

        notice = findViewById(R.id.noticevermouth);
        // 로그인한 정보 가져오기
        firebaseAuth = FirebaseAuth.getInstance();
        user = firebaseAuth.getCurrentUser();

        // 툴바생성
        Toolbar toolbar = findViewById(R.id.vermouth_bar);
        ...
        // 리사이클러뷰
        mRecyclerView = (RecyclerView) findViewById(R.id.vermouth_recyclerView); // 리사이클러뷰 초기화
    ...
    private void LoadRecyclerview() {
        ...
        db.collection("Main_Board")
                .whereEqualTo("Category", "Vermouth")
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        for(DocumentSnapshot ds : queryDocumentSnapshots){
                            ...
                            mRecyclerAdapter = new MyRecyclerAdapter(VermouthActivity.this, mBoardModel);
        ...
        switch (item.getItemId()){
            ...
            case R.id.post:{
                if (user == null){
                    ...
                    Intent intent = new Intent(VermouthActivity.this, PostActivity.class);
