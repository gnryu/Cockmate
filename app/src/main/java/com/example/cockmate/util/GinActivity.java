...
public class GinActivity extends AppCompatActivity {
    ...
    private static final String TAG = "GinActivity";
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        notice = findViewById(R.id.noticegin);
        // 로그인한 정보 가져오기
        firebaseAuth = FirebaseAuth.getInstance();
        user = firebaseAuth.getCurrentUser();

        // 툴바생성
        Toolbar toolbar = findViewById(R.id.gin_bar);
        ...
        // 리사이클러뷰
        mRecyclerView = (RecyclerView) findViewById(R.id.gin_recyclerView); // 리사이클러뷰 초기화
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        for(DocumentSnapshot ds : queryDocumentSnapshots){
                            ...
                            mRecyclerAdapter = new MyRecyclerAdapter(GinActivity.this, mBoardModel);
        ...
        switch (item.getItemId()){
            ...
            case R.id.post:{
                if (user == null){
                    ...
                    Intent intent = new Intent(GinActivity.this, PostActivity.class);
