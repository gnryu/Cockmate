...
public class RumActivity extends AppCompatActivity {
    ...
    private static final String TAG = "RumActivity";
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        notice = findViewById(R.id.noticerum);
        // 로그인한 정보 가져오기
        firebaseAuth = FirebaseAuth.getInstance();
        user = firebaseAuth.getCurrentUser();

        // 툴바생성
        Toolbar toolbar = findViewById(R.id.rum_bar);
        ...
        // 리사이클러뷰
        mRecyclerView = (RecyclerView) findViewById(R.id.rum_recyclerView); // 리사이클러뷰 초기화
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        for(DocumentSnapshot ds : queryDocumentSnapshots){
                            ...
                            mRecyclerAdapter = new MyRecyclerAdapter(RumActivity.this, mBoardModel);
        ...
        switch (item.getItemId()){
            ...
            case R.id.post:{
                if (user == null){
                    ...
                    Intent intent = new Intent(RumActivity.this, PostActivity.class);
