...
public class BeerActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        notice = findViewById(R.id.noticebeer);
        // 로그인한 정보 가져오기
        ...
        // 툴바생성
        Toolbar toolbar = findViewById(R.id.beer_bar);
        ...
        // 리사이클러뷰
        mRecyclerView = (RecyclerView) findViewById(R.id.beer_recyclerView); // 리사이클러뷰 초기화
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        for(DocumentSnapshot ds : queryDocumentSnapshots){
                            ...
                            mRecyclerAdapter = new MyRecyclerAdapter(BeerActivity.this, mBoardModel);
        ...
        switch (item.getItemId()){
            ...
            case R.id.post:{
                if (user == null){
                    ...
                    Intent intent = new Intent(BeerActivity.this, PostActivity.class);
