...
public class ResultView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (Result result : mResults) {
            ...
            canvas.drawText(String.format("주류 감지", PrePostProcessor.mClasses[result.classIndex], result.score), result.rect.left + TEXT_X, result.rect.top + TEXT_Y, mPaintText);
