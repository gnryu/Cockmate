...
public class BrandyActivity extends AppCompatActivity {

    private static final String TAG = "BrandyActivity";
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        // 툴바생성
        Toolbar toolbar = findViewById(R.id.brandy_bar);
        ...
        // 리사이클러뷰
        mRecyclerView = (RecyclerView) findViewById(R.id.brandy_recyclerView); // 리사이클러뷰 초기화
        ...
        switch (item.getItemId()){
            ...
            case R.id.post:{
                if (user == null){
                    ...
                    Intent intent = new Intent(BrandyActivity.this, PostActivity.class);
