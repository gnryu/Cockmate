...
public class WineActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        notice = findViewById(R.id.noticewine);
        // 로그인한 정보 가져오기
        firebaseAuth = FirebaseAuth.getInstance();
        user = firebaseAuth.getCurrentUser();

        // 툴바생성
        Toolbar toolbar = findViewById(R.id.wine_bar);
        ...
        // 리사이클러뷰
        mRecyclerView = (RecyclerView) findViewById(R.id.wine_recyclerView); // 리사이클러뷰 초기화
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        for(DocumentSnapshot ds : queryDocumentSnapshots){
                            ...
                            mRecyclerAdapter = new MyRecyclerAdapter(WineActivity.this, mBoardModel);
        ...
        switch (item.getItemId()){
            ...
            case R.id.post:{
                if (user == null){
                    ...
                    Intent intent = new Intent(WineActivity.this, PostActivity.class);
